...
type CrawlerMasterClient interface {
	...
	DelResource(ctx context.Context, in *ResourceSpec, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *crawlerMasterClient) AddResource(ctx context.Context, in *ResourceSpec, opts ...grpc.CallOption) (*NodeSpec, error) {
	out := new(NodeSpec)
	err := c.cc.Invoke(ctx, "/protos.CrawlerMaster/AddResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crawlerMasterClient) DelResource(ctx context.Context, in *ResourceSpec, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/protos.CrawlerMaster/DelResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCrawlerMasterServer) DelResource(context.Context, *ResourceSpec) (*emptypb.Empty, error) {
...
func _CrawlerMaster_AddResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.CrawlerMaster/AddResource",
	}
...
func _CrawlerMaster_DelResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResourceSpec)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CrawlerMasterServer).DelResource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.CrawlerMaster/DelResource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CrawlerMasterServer).DelResource(ctx, req.(*ResourceSpec))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CrawlerMaster_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protos.CrawlerMaster",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CrawlerMaster_DelResource_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protos/crawler/crawler.proto",
}
